...
public class ProfileEditForm {
	...
	public static ProfileEditForm from(Member entity) {
		return new Builder()
				...
				.region(entity.getTownship() != null ? entity.getTownship().getDistrict().getRegion().getId() : null)
				.district(entity.getTownship() != null ? entity.getTownship().getDistrict().getId() : null)
				.township(entity.getTownship() != null ? entity.getTownship().getId() : null)
